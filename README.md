...
- **Ход работы:**
 ...
 - Выполняем команды из первой части лабораторной работы.  
![image](https://user-images.githubusercontent.com/104266946/167249219-638b6168-da2d-41f3-b5b7-805ea4d9480e.png)  
![image](https://user-images.githubusercontent.com/104266946/167249228-8b006900-1a4e-45fb-ad0d-d24b806a6478.png)  



 - Переходим в каталог /usr/include/sys  
![image](https://user-images.githubusercontent.com/104266946/167249251-e7b7e000-e299-4a3a-a3ca-bc17d28b5dc0.png)  

 - Просматриваем файлы  
![image](https://user-images.githubusercontent.com/104266946/167249256-340ef62b-f831-4cbd-926d-09cbfa7d1790.png)  


 - Копируем файл io.h в домашний каталог  
![image](https://user-images.githubusercontent.com/104266946/167249273-480ed475-59e9-43bf-bea3-a73f812f2de0.png)  


 - Затем проверяем, скопировался ли файл  
![image](https://user-images.githubusercontent.com/104266946/167249283-c2580ecb-0488-4372-9d34-f4106fb1516c.png)  


 - Он скопировался и у меня получилось это сделать.  

 - Далее создаем каталог ski.plases  
![image](https://user-images.githubusercontent.com/104266946/167249309-8eead097-259d-4306-8401-b786bafc5278.png)  


 - Переименовываем io.h в equipment и перемещаем его в equiplist.  
![image](https://user-images.githubusercontent.com/104266946/167249365-da0f544b-18f4-4337-8b52-83ead196b775.png)  


 - Создаем файл abc1 и переименовываем его в equiplist2.  
![image](https://user-images.githubusercontent.com/104266946/167249405-e50f825c-91b4-4e77-aedc-d04e6a5c627b.png)  


 - Создаем каталог equipment и переносим наши equiplist и equiplist2 в него.  
![image](https://user-images.githubusercontent.com/104266946/167249447-1ce218cf-533b-4d88-a7db-f46d6e28591a.png)  


 - Переносим каталог newdir из прошлой лабораторной работы в каталог ski.plases и переименовываем его в plans.  
![image](https://user-images.githubusercontent.com/104266946/167249482-f167e655-e98c-423f-9375-5451b403a60b.png)  


 - Далее работаем с командой chmod и просматриваем, что она умеет делать, таким же образом, просматриваем команды mount, fsck, mkfs и kill.  
![image](https://user-images.githubusercontent.com/104266946/167249530-4d38e6c3-ab96-4b4c-918f-089581e71696.png)  
...
### Вывод: Я ознакомился с файловой системой Linux, её структурой, именами и содержанием каталогов. Приобрел практические навыки по применению команд для работы с файлами и каталогами, по управлению процессами, по проверке использования диска и обслуживанию файловой системы.
